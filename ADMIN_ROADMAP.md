...
- `supabase/migrations/016_admin_users_insert_event_candidates_policy.sql`：INSERT policy
- `supabase/migrations/017_event_candidates_dedupe_fields.sql`：source_hash + raw_data columns + unique index
