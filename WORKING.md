...
| 73 | UI-5 首頁 `/` Today Archive v1 | 以首頁 `/` 為唯一範圍，將入口頁升級成 Today Archive / control deck：暖紫黑 cassette 語言、今日 spotlight、快速入口、個人化區塊與首頁 timeline 視覺統一；不改資料邏輯、query、DB、crawler、auth、其他頁 | ⏳ PR 待驗收 |
