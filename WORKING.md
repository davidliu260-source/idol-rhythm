...
| 042 | Create notifications table（user-scoped RLS + service_role INSERT + type CHECK + (user_id, dedupe_key) UNIQUE index + user_created_at / user_unread partial index）— N3 v1 資料模型 | ⏳ 待使用者手動到 Supabase SQL Editor 執行 |
