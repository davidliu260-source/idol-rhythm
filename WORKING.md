...
| 72 | UI-4 `/favorites` Archive Shelf | 以 `/favorites` 為唯一範圍，將收藏頁升級成 archive shelf：暖紫黑 cassette 語言、收藏統計 header、搜尋保留、登入提示 / 空狀態升級、即將到來與已歸檔分區、收藏卡片層級重做，並補上月份分組與 archived accordion；不改 query、DB、crawler、auth、其他頁 | ⏳ PR #100 待驗收 |
