...
| 57 | 中文顯示 + 快閃店資料模型工作單 | `DISPLAY_LOCALIZATION_AND_POPUP_WORK_ORDER.md`：規劃原文保留、中文展示欄位、AI/規則中文摘要、人工覆寫、快閃店日期區間與地點模型、sub_type 擴充與後續 PR 拆分；僅工作單，未改 DB / UI / crawler | ✅ PR 待 merge（無 migration）|
